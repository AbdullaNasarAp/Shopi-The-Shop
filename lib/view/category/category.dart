      ...
      body: Padding(
        ...
        child: Consumer<ProductProvider>(
          builder: (context, value, child) {
            return productCategory.category.isEmpty
                ? Center(
                            ...
                            Center(
                              child: Padding(
                                ...
                                child: Card(
                                  ...
                                  color: Colors.red[50],
                                  child: Image.network(
                                    "http://172.16.1.180:5005/products/${productCategory.image[0]}",
                                    width: 120,
                                    height: 120,
                                  ),
                                ),
